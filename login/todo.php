...
<div id="logmsk" style="display: block;">
    ...
    <div id="userbox">
        <h1 accesskey="index.php" id="signup" style="background-color: rgb(112, 120, 119); background-position: initial initial; background-repeat: initial initial;">Lista de Tareas ♦ <?php echo '<strong>'.$_SESSION['name'].'</strong>';?> ♦</h1>
