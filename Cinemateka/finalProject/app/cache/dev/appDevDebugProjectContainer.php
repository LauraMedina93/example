...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            'kernel.root_dir' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/logs',
            ...
            'session.save_path' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/assetic/routing.yml',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/doctrine/orm/Proxies',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setProxyDir('C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bf217c83c07353e5acc3a4fa84ae1d9630da97d6c7b2cf20d6af5deef82c149d');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/example/Cinemateka/finalProject/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/example/Cinemateka/finalProject/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/example/Cinemateka/finalProject/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/example/Cinemateka/finalProject/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:/xampp/htdocs/example/Cinemateka/finalProject/app/Resources/views');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/example/Cinemateka/finalProject/app/cache/dev');
    }
